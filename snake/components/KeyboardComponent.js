// Component to handle keyboard input for controlling the snake movement and event handlers
...
class KeyboardComponent extends Component{
    ...
    update(){
        // update keyboard input and store the next move
        ...
        // check if it's time to move, then move
        if(this.timeLeftToMove <= 0){
            ...
            while(currentBodyPart){
                ...
                // check if snake needs to grow a new body segment
